...
<body>
    ...
    <div class="page-header">
        <h3>Download <span class="label label-default">Version1 10.1</h3>
    </div>

    <br />
    <div class="alert alert-danger fade in"><a href="#" class="close" data-dismiss="alert">&times;</a><img
            src="https://img.freepik.com/free-photo/painting-mountain-lake-with-mountain-background_188544-9126.jpg"
            class="img-rounded"></div>
    <div class="alert alert-success"><a href="#" class="close" data-dismiss="alert">&times;</a><img
            src="https://img.freepik.com/free-photo/painting-mountain-lake-with-mountain-background_188544-9126.jpg"
            class="img-circle"></div>
    <div class="alert alert-warning"><a href="#" class="close" data-dismiss="alert">&times;</a><img
            src="https://img.freepik.com/free-photo/painting-mountain-lake-with-mountain-background_188544-9126.jpg"
    ...
    <button class="btn btn-success"><span class="glyphicon glyphicon-search"></span><a
            href="https://www.w3schools.com/bootstrap/bootstrap_ref_comp_glyphs.asp">Find</a></button>
    ...
    <br />
    <div class="dropup">
        <button class="btn btn-primary dropdown-toggle" data-toggle="dropdown">College<span
                class="caret"></span></button>
        <ul class="dropdown-menu">
            <li><a href="https://en.wikipedia.org/wiki/Carbon_capture_and_storage">CCS</a></li>
            <li><a href="https://en.wikipedia.org/wiki/Central_European_Time">CET</a></li>
            <li><a href="https://en.wikipedia.org/wiki/Central_European_Time">CBA</a></li>
            <li class="divider"></li>
    ...
    <button class="btn btn-btn-link">Click Me</button>
